...
describe('Material e2e test', () => {
  const materialPageUrl = '/material-my-suffix';
  const materialPageUrlPattern = new RegExp('/material-my-suffix(\\?.*)?$');
  ...
  it('Materials menu should load Materials page', () => {
    cy.visit('/');
    cy.clickOnEntityMenuItem('material-my-suffix');
  ...
  describe('Material page', () => {
    describe('create button click', () => {
      ...
      it('should load create Material page', () => {
        ...
        cy.url().should('match', new RegExp('/material-my-suffix/new$'));
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Material page', () => {
  ...
  describe('new Material page', () => {
    ...
    it('should create an instance of Material', () => {
      cy.get(`[data-cy="typeOfMaterial"]`).select('PS');

      cy.get(`[data-cy="subTotalWeight"]`).type('51551').should('have.value', '51551');
